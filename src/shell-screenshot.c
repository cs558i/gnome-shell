                    ...
                    ShellScreenshotFlag  flags)
{
  ...
  if (!clutter_stage_paint_to_buffer (stage, &screenshot_rect, scale,
                                      ...
                                      COGL_PIXEL_FORMAT_CAIRO_ARGB32,
                                      paint_flags,
                                      &error))
    {
                   ...
                   cairo_rectangle_int_t  area)
{
  ...
  cogl_texture_get_data (texture, COGL_PIXEL_FORMAT_CAIRO_ARGB32, stride, data);
                                      ...
                                      gpointer             user_data)
{
  ...
  cogl_texture_get_data (sub_texture, COGL_PIXEL_FORMAT_CAIRO_ARGB32,
                         cairo_image_surface_get_stride (surface),
                         cairo_image_surface_get_data (surface));
  ...
  if (cursor != NULL)
    {
      ...
      cogl_texture_get_data (cursor, COGL_PIXEL_FORMAT_CAIRO_ARGB32,
