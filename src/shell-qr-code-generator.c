               ...
               GError      **error)
{
  ...
  guint8 white_pixel[4] = {255, 255, 255, 255};
#if G_BYTE_ORDER == G_LITTLE_ENDIAN
  guint8 black_pixel[4] = {0, 0, 0, 255};
#else
  guint8 black_pixel[4] = {255, 0, 0, 0};
#endif
                        ...
                        gpointer              user_data)
{
  ...
  g_task_return_pointer (self->priv->icon_task, g_steal_pointer (&content), NULL);
}
                                          ...
                                          gpointer              user_data)
{
  ...
  //g_object_unref (priv->image_task);
}
